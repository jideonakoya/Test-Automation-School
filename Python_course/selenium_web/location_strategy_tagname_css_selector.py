...
def locate_by_tag_name(driver):
    ...
    for div in div_elements:
        print("Div Elements", div_elements)
...
def locate_by_css_selector(driver):
    ...
    print("First Name by css selector", firstname_element)
    input_elements = driver.find_elements(By. CSS_SELECTOR, "div.relative") # div.relative means div that has a class called relative
